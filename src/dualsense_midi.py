...
def main():
    ...
    if not controller or not motion or not touchpad:
        print("DualSense controller, motion sensors, or touchpad not found!")
        print(f"Found - Controller: {controller is not None}, Motion: {motion is not None}, Touchpad: {touchpad is not None}")
        return
